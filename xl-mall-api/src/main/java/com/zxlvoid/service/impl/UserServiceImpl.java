...
public class UserServiceImpl implements IUserService {
	...
	@Override
	public ServerResponse<String> testApi() {
		User username = userMapper.selectByPrimaryKey(1);
		return ServerResponse.createBySuccessMessage(username.getUsername());
	}
